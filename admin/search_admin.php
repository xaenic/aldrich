          ...
          <label class="">Purpose of SitIn</label>
                ...
                <div class="bg-green-500 px-3 p-2 text-white text-center mt-3 rounded-md"> 
                  <a class="w-full"href="./history.php?id=<?php echo  $student['id'];?>">View History</a>
                    ...
                    <div class="mt-10">
                        <a href="./reset_password.php?id=<?php echo $student['id'];?>&sid=<?php echo $student['idno'];?>" class="font-semibold cursor-pointer px-3 p-2  rounded-md bg-orange-500 text-stone-50">Reset Password</a>
                    <a href="./reset_sessions.php?id=<?php echo $student['id'];?>&sid=<?php echo $student['idno'];?>" class="font-semibold cursor-pointer px-3 p-2  rounded-md bg-zinc-500 text-stone-50">Reset Sessions</a>
                    </div>
         </form>
